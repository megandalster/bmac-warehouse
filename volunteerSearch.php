 ...
 * Allen Tucker. This program is part of Homerestore, which is free software.
			...
			<div id="content">
				...
				// display the search form
					...
					echo('<form method="post">');
						...
						echo '<br><br>Role:<select name="s_type">';
							echo '<option value=""'; if ($type=="") echo " SELECTED"; echo '>--all--</option>'; 
							echo '<option value="driver"'; if ($type=="driver") echo " SELECTED"; echo '>Driver</option>'; 
							echo '<option value="floater"'; if ($type=="floater") echo " SELECTED"; echo '>Floater</option>';
							echo '<option value="warehouse"'; if ($type=="warehouse") echo " SELECTED"; echo '>Warehouse</option>'; 
							echo '<option value="pricer"'; if ($type=="pricer") echo " SELECTED"; echo '>Pricer</option>';
							echo '<option value="register"'; if ($type=="register") echo " SELECTED"; echo '>Register</option>';
							echo '<option value="manager"'; if ($type=="coordinator") echo " SELECTED"; echo '>Coordinator</option>';
                        echo '</select>';
